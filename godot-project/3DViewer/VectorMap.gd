...
func _process(_delta):
	...
	# Road Marker (cool-white markings + amber stop lines as separate surfaces)
	...
	var stop_line_verts = vector_map.get_linestring_triangle_list("stop_line", 0.5)
	road_marker.visualize_mesh(road_marker_verts, stop_line_verts)
	# Traffic Light
