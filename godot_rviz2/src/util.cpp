...
bool isClockWise(const geometry_msgs::msg::Polygon &polygon)
{
    ...
    {
        sum +=
            (polygon.points.at(i).x - x_offset) * (polygon.points.at((i + 1) % n).y - y_offset) -
    ...
    geometry_msgs::msg::Polygon &polygon)
{
    if (shape.type == autoware_auto_perception_msgs::msg::Shape::BOUNDING_BOX)
    {
        ...
        {
            Eigen::Vector2d offset = rotation * Eigen::Vector2d(shape.dimensions.x * 0.5f, shape.dimensions.y * 0.5f);
